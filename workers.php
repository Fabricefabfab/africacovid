                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                           <ul>
                              ...
                              <li><a class="active" href="workers.php">Workers</a></li>
...
<br>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">Medical Officers
                        </div>
                        <div class="card-body">
                          <?php 
                          $sql = "SELECT * FROM medicalofficers";
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">Managers
                        </div>
                        <div class="card-body">
                          <?php 
                               ...
                               echo '<table class="table table-bordered" id="dataTable" width="50%" cellspacing="0">';
                                    echo '<thead>';
                                        echo '<tr>';
                                           ...
                                           echo '<th data-field>Manager ID</th>';
                                           echo '<th >Citizen ID</th>'; 
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">Public Relations Officers
                        </div>
                        <div class="card-body">
                          <?php 
