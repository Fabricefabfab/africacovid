   ...
   <body class="main-layout">
      ...
      <!-- top -->
         ...
         <header class="header-area">
            ...
            <div class="right">
               <a href="admin_index.php" ><i class="fa fa-user" aria-hidden="true"></i></a>
            </div>
            <div class="container">
                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                           <ul>
                              ...
                              <li><a href="doctors.html">Vaccinations</a></li>
                     ...
                     <div class="carousel-caption cuplle">
                        <div class="container">
                           <div class="row">
                              <div class="col-md-8">
                                 <div class="photog">
                                    <h1>COVID vaccines<br>and associated vaccination schedules</h1>
         ...
         <div class="container">
            <div class="row d_flex grid">
               ...
               <div class="col-md-5 oder1">
                  <div class="titlepage text_align_left">
                     <h2>Coronavirus how it spreads?</h2>
                  ...
                  <div class="owl-carousel owl-theme">
                     <div class="item">
                        <div class="protect_box text_align_center">
                          <div class="desktop">
                           ...
                           <h3> Wear Mask</h3>
                           <span> Masks are a key measure to suppress transmission and save lives. Masks should be used as part of a comprehensive 'Do it all!' approach</span>
                          </div>
                     ...
                     <div class="item">
                          ...
                          <div class="desktop">
                           ...
                           <span> Hand Hygiene is one of the most effective actions to reduce the spread of pathogens and prevent infections, including the COVID-19 virus.</span>
                          </div>
                     ...
                     <div class="item">
                         <div class="protect_box text_align_center">
                          <div class="desktop">
                           ...
                           <h3> Stay at Home</h3>
                           <span> Stay home and self-isolate even if you have minor symptoms such as cough, headache, mild fever, until you recover. Call your health care provider or hotline for advice.</span>
                          </div>
            ...
            <div class="row d_flex">
               <div class=" col-md-6">
                     <div id="ho_efcet" class="reader text_align_center">
                        ...
                        <h3>Dr.Odaliz Abreu Lanfranco</h3>
                        <p>We are assuming that some patients with COVID-19 will have minimal symptoms or might not have symptoms and that they can infect other individuals that might be at higher risks for poor outcomes. By slowing the spread of COVID-19, they help their providers be able to provide the appropriate care because not everybody will come at once to the hospital.</p>
            ...
            <div class="container">
               <div class="row">
                        ...
                        <li><i class="fa fa-envelope" aria-hidden="true"></i>
                           <a href="Javascript:void(0)">Email : Team2hackaton@gmail.com</a>
                        </li>
                     </ul>
